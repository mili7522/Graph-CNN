...
SA1s = pd.read_csv('2018-06-01-NSW-SA1Input.csv', usecols = [0], squeeze = True)
getGCC(SA1s, links, 'Geography/2018-06-01-NSW-Neighbouring_Suburbs_With_Bridges-GCC.csv', 'Geography/2018-06-01-NSW-SA1s.csv')

# VIC
linkFile = "Geography/2018-06-07-VIC-Neighbouring_Suburbs_With_Bridges.csv"
links = pd.read_csv(linkFile)
SA1s = pd.read_csv('2018-06-07-VIC-SA1Input.csv', usecols = [0], squeeze = True)
getGCC(SA1s, links, 'Geography/2018-06-07-VIC-Neighbouring_Suburbs_With_Bridges-GCC.csv', 'Geography/2018-06-07-VIC-SA1s.csv')
